...
class Decoder(nn.Module):
    ...
    def forward(self, trg, src, trg_mask=None,src_mask=None):
        ...
        #print("after decoder layer:", trg.shape)
        ...
        #print("sum shape after normalizing:", sum.shape)
...
class Predictor(nn.Module):
    ...
    def gcn(self, input, adj):
        ...
        #print(" compound",input.shape)
        expanded_weight = self.weight.unsqueeze(0)
        support = torch.matmul(input, expanded_weight)
    ...
    def forward(self, compound, adj, protein):
        ...
        #print(" compound of gcn: ",compound.shape)
        ...
        #print("protein before going to encoder", protein.shape)
