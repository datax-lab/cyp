...
DIR_NAME = BASE_PATH + '/phase1_new/iteration_' + str(iteration) +'/cpi/' + 'Attempt_' + str(ATTEMPT) + '/'
...
# spy_smiles_compound = [smile_compound_data[i] for i in spy_indices]
# spy_smiles_adjacency = [smile_adjacency_data[i] for i in spy_indices]
# spy_proteins = [protein_data[i] for i in spy_indices]
# spy_targets = [targets[i] for i in spy_indices]
...
#             ###--------------------------------------TRAIN PREDICTIONS------------------------------------------###
        ...
        while(j+BATCH_SIZE  <= len(untouched_spy_indices)):
            #print(smile_compound_data[untouched_spy_indices[j:j+BATCH_SIZE][0]])
            #print(smile_compound_data[untouched_spy_indices[j:j+BATCH_SIZE][0]].shape)
            #sys.exit()
...
#             ###--------------------------------------SPY PREDICTIONS------------------------------------------------###
        ...
        while(j+BATCH_SIZE  <= len(untouched_test_indices)):
            #print(smile_compound_data[untouched_test_indices[j:j+BATCH_SIZE][0]])
            #print(smile_compound_data[untouched_test_indices[j:j+BATCH_SIZE][0]].shape)
            #sys.exit()
