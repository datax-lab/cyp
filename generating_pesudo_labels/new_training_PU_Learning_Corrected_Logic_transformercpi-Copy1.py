...
DIR_NAME = BASE_PATH + '/phase_1_iterations/transformercpi/' + 'Attempt_' + str(ATTEMPT) + '/'
...
spy_smiles_compound = tt_smile_compound_data[spy_samples]
spy_smiles_adjacency = tt_smile_adjacency_data[spy_samples]
spy_proteins = tt_protein_data[spy_samples]
spy_targets = targets[spy_samples]
...
unlabeled_smiles_compound_e = tt_smile_compound_data[unlabeled_indices]
unlabeled_smiles_adjacency_e = tt_smile_adjacency_data[unlabeled_indices]
unlabeled_proteins_e = tt_protein_data[unlabeled_indices]
unlabeled_targets_e = targets[unlabeled_indices]
...
unlabeled_smiles_compound = unlabeled_smiles_compound[shuffled_indices]
unlabeled_smiles_adjacency = unlabeled_smiles_adjacency[shuffled_indices]
unlabeled_proteins = unlabeled_proteins[shuffled_indices]
unlabeled_targets = unlabeled_targets[shuffled_indices]
print("-"*50)
...
# CUDA...
    ...
    train_unlabeled_smiles_adjacency = unlabeled_smiles_adjacency[train_unlabeled_indices]
    train_unlabeled_proteins = unlabeled_proteins[train_unlabeled_indices]
    train_unlabeled_targets_unchanged = unlabeled_targets[train_unlabeled_indices]
    train_unlabeled_targets = unlabeled_targets[train_unlabeled_indices]
...
#         ###-------------------------TRAIN PREDICTIONS------------------------------------------------###
        ...
        touched_spy_indices[i] = torch.nonzero(train_unlabeled_targets_unchanged == 1)
