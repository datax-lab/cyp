...
BASE_PATH = "/home/yaganapu/CYP/cyp_update/benchmarks/new_training_setting"
...
DIR_NAME = BASE_PATH + '/phase1/ssnet/' + 'ssnet_Attempt_' + str(ATTEMPT) + '/'
...
train_randomized_data_path = '/home/yaganapu/CYP/cyp_update/benchmarks/phase1_data/iteration_1/train_indices.npy'
val_randomized_data_path = '/home/yaganapu/CYP/cyp_update/benchmarks/phase1_data/iteration_1/val_indices.npy'
test_randomized_data_path = '/home/yaganapu/CYP/cyp_update/benchmarks/phase1_data/iteration_1/test_indices.npy'
...
train_pos_smiles_compound = [smile_compound_data[i] for i in train_pos_indices if i not in incorrect_indices]
train_pos_smiles_adjacency = [smile_adjacency_data[i] for i in train_pos_indices if i not in incorrect_indices]
train_pos_proteins = [protein_data[i] for i in train_pos_indices if i not in incorrect_indices]
train_pos_targets = [targets[i] for i in train_pos_indices if i not in incorrect_indices]
